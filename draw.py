...
def main():
    ...
    ap.add_argument("--txt", required=True, help="KITTI pose txt file (each row: 12 floats 3x4)")
    ap.add_argument("--equal", action="store_true", help="Use equal axis scaling")
    args = ap.parse_args()

    t = load_kitti_poses_txt(args.txt)
    x, y = t[:, 0], t[:, 1]
